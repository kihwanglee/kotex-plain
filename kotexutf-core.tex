...
\count@"C2 \loop
  ...
  \begingroup
  \lccode`\~\count@
  \lowercase{\endgroup \protected\def~{\unihangul@ii@octs~}}
...
\count@"E0 \loop
  ...
  \begingroup
  \lccode`\~\count@
  \lowercase{\endgroup \protected\def~{\unihangul@iii@octs~}}
...
\count@"F0 \loop
  ...
  \begingroup
  \lccode`\~\count@
  \lowercase{\endgroup \protected\def~{\unihangul@iv@octs~}}
